export enum ResponseMessages {
  ...
  NOT_CONFIGURED_EMAIL_SETTINGS = 'NOT_CONFIGURED_EMAIL_SETTINGS',
  ...
  LABEL_SLUG_ALREADY_EXIST = 'LABEL_SLUG_ALREADY_EXIST',
  ...
  LABEL_TITLE_ALREADY_EXIST = 'LABEL_TITLE_ALREADY_EXIST',
  FAILED_CREATE_CATEGORY = 'FAILED_CREATE_CATEGORY',
  FAILED_CREATE_LABEL = 'FAILED_CREATE_LABEL',
  FAILED_UPDATE_CATEGORY = 'FAILED_UPDATE_CATEGORY',
  FAILED_UPDATE_LABEL = 'FAILED_UPDATE_LABEL',
  FAILED_GET_CATEGORY_LIST = 'FAILED_GET_CATEGORY_LIST',
  FAILED_GET_LABEL_LIST = 'FAILED_GET_LABEL_LIST',
  FAILED_DELETE_CATEGORIES = 'FAILED_DELETE_CATEGORIES',
  FAILED_DELETE_LABELS = 'FAILED_DELETE_LABELS',
  ...
  LABEL_CREATED_SUCCESS = 'LABEL_CREATED_SUCCESS',
  ...
  FAILED_CREATE_SLUG_CONFIG = 'FAILED_CREATE_SLUG_CONFIG',
  FAILED_CREATE_READING_CONFIG = 'FAILED_CREATE_READING_CONFIG',
  FAILED_SET_CONFIG_SLUG = 'FAILED_SET_CONFIG_SLUG',
  NOT_CONFIGURED_SLUG_SETTINGS = 'NOT_CONFIGURED_SLUG_SETTINGS',
  NOT_CONFIGURED_READING_SETTINGS = 'NOT_CONFIGURED_SLUG_SETTINGS',
  TYPE_SHULDE_BE_PRODUCT_OR_POST = 'TYPE_SOULED_BE_PRODUCT_OR_POST',
  SUBLABEL_SLUG_ALREADY_EXIST = 'SUBLABEL_SLUG_ALREADY_EXIST',
}
